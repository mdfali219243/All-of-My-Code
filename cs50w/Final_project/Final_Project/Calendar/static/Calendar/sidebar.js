document.addEventListener('DOMContentLoaded', function() {
    ...
    const featureBtn = document.getElementById('featureMenuBtn');
    
    // Let CSS control default visibility; avoid inline overrides that break mobile off-canvas
    ...
    function toggleSidebar() {
        ...
        if (featureBtn) featureBtn.setAttribute('aria-expanded', isExpanded);
    ...
    function handleClickOutside(event) {
        const clickedToggle =
            ...
            (featureBtn && featureBtn.contains(event.target));
    ...
    function closeSidebar() {
        ...
        if (featureBtn) featureBtn.setAttribute('aria-expanded', 'false');
        document.removeEventListener('click', handleClickOutside);
    }
    ...
    if (featureBtn) {
        featureBtn.addEventListener('click', function(e) {
            e.preventDefault();
            // Ensure no other listeners (e.g., Bootstrap dropdown) run on this element
